'''
Name: Geohash_Test.py 

Testing the algorithm to find match geohash codes between Bob_dataset and Oneday_dataset
which contains 63 files 

12/2/2022 
Note: 
Done with testing system -- result = OKAY (got the number right)
...
os.chdir(path)
remember = 'system_test_export.csv'
...
memmory_pd = pd.read_csv('C:/Users/User/Desktop/' + 'system_test.csv')['geohash']
memroy_dictionary = {}
...
# Test with system_test dataset (contains 40 row) and output -- system_test_export